...
which is the same argument `train.cache` makes at a larger scale, and the reason
...
and `train.weighting` differentiates through it to decide where the adapter
spends its capacity.
"""
...
from train.tracker import build_tracker, flatten_config
