"""Stage 2: train the discrepancy head against a FROZEN stage-1 adapter.
    ...
    python scripts/train_discrepancy.py train/configs/train/dinov3_discrepancy.yaml
    python scripts/train_discrepancy.py train/configs/train/dinov3_discrepancy.yaml --adapter checkpoints/grace/dinov3_clean/step_001000.pt --run-id e4_step1000
...
from train.loop import train_discrepancy
