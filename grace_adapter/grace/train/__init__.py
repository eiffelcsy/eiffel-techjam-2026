...
from grace.train.losses import (
    alignment_loss, head_kl, identity_loss, severity_loss, sliced_wasserstein,
    supervised_bce, total_loss,
)
...
__all__ = [
    ...
    "alignment_loss", "identity_loss", "head_kl", "severity_loss",
    "sliced_wasserstein", "supervised_bce", "total_loss",
