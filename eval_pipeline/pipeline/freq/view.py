...
time. This module is the thin callable wrapper the three paths actually hold:
    ...
    render   grace.cache.writer.MultiViewDataset, in a DataLoader worker
    train    grace.train.loop.train_enrich, through the cached view
    eval     grace.detectors.fused.FusedDetector.aux_fn(), in a worker again
